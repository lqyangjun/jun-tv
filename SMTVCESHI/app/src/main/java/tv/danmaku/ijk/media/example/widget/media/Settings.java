...
public class Settings {
    ...
    public int getPlayer() {
        ...
        //System.out.println("getPlayer为：" + this.mSharedPreferences.getString(this.mAppContext.getString(R.string.pref_key_player), ""));
        try {
            return Integer.valueOf(value).intValue();
        } catch (NumberFormatException e) {
//            return 0;
            if (nhposition == 0){
                return VideoPlayerActivity.nhposition;
            }else{
                return LivePlayerActivity.nhposition;
            }
