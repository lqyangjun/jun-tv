...
public class LivePlayerActivity extends Activity implements OnClickListener {
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                ...
                case WindowMessageID.NOTICE:
                    ...
                    int Vod_Notice_end_time = SharePreferenceDataUtil.getSharedIntData(LivePlayerActivity.this, "Vod_Notice_end_time", 0);
    ...
    /*远程logo地址*/
    private String logo_url = Rc4.decry_RC4(SharePreferenceDataUtil.getSharedStringData(LivePlayerActivity.this, "Logo_url", null),Constant.d);
    /*解析客户端*/
...
//    private int caton_check = sp.getInt("caton_check", 0);////卡顿校验
    int caton_check = SharePreferenceDataUtil.getSharedIntData(LivePlayerActivity.this, "caton_check", 0);////卡顿校验
...
//    int check_time = 10;////卡顿校验时间
    ...
    int check_time = SharePreferenceDataUtil.getSharedIntData(LivePlayerActivity.this, "check_time", 10);////卡顿校验时间
...
//    private int Tackle_mode = sp.getInt("Tackle_mode", 1);////卡顿解决方式
    private int Tackle_mode = SharePreferenceDataUtil.getSharedIntData(LivePlayerActivity.this, "Tackle_mode", 1);////卡顿解决方式
...
//    private int networkspeed = sp.getInt("networkspeed", 1);////显示网速
    private int networkspeed = SharePreferenceDataUtil.getSharedIntData(LivePlayerActivity.this, "networkspeed", 1);////显示网速
...
//    private int epg = sp.getInt("epg", 1);////EPG风格
    private int epg = SharePreferenceDataUtil.getSharedIntData(LivePlayerActivity.this, "epg", 1);////EPG风格
...
//    private int switchs = sp.getInt("switchs", 1);////换台方式
    private int switchs = SharePreferenceDataUtil.getSharedIntData(LivePlayerActivity.this, "switchs", 1);////换台方式
...
//    private int memory_source = sp.getInt("memory_source", 1);////记忆播放源
    private int memory_source = SharePreferenceDataUtil.getSharedIntData(LivePlayerActivity.this, "memory_source", 1);////记忆播放源
...
//    private int memory_channel = sp.getInt("memory_channel", 1);////记忆频道
    private int memory_channel = SharePreferenceDataUtil.getSharedIntData(LivePlayerActivity.this, "memory_channel", 1);////记忆频道
...
//    private int live_no_source = sp.getInt("live_no_source", 0);////源用尽处理方式
    private int live_no_source = SharePreferenceDataUtil.getSharedIntData(LivePlayerActivity.this, "live_no_source", 0);////源用尽处理方式
...
//                timer.schedule(task, 500);
    ...
    private void findViewById() {
        ...
        ll_epg1 = (ConstraintLayout) findViewById(R.id.ll_epg1);////EPG1框架
...
//        mediaHandler.sendEmptyMessageDelayed(WindowMessageID.TV_COVER, 1000);////换台遮挡
    ...
    private void getVodGongGao() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, User_url + "/api.php?app=" + Api.APPID + "&act=live_notice",
