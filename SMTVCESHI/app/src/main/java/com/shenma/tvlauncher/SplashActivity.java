        ...
        public void handleMessage(android.os.Message msg) {
            switch (msg.what) {
                case 0:
                    ...
                    handler.sendEmptyMessageDelayed(DETECTION_NET, 15000);
                    break;
                case 1:
                    /*显示广告*/
...
//        openActivity(HomeActivity.class);
    ...
    private void isNetWork() {
        ...
        handler.sendEmptyMessageDelayed(18, 1000);
    }
    ...
    private void CosMainurl(){
        ...
        /*请求云COS地址*/
        StringRequest stringRequest = new StringRequest(Request.Method.GET, new String( Base64.decode(Utils.strRot13(new String(Base64.decode(Api.COS_MIAN_URL, 1))), 1)),
...
//            System.out.println("解码模式：硬解" + Utils.strRot13(new String(Base64.decode(Utils.strRot13(type), 1)))  );
    ...
    public void CosError(VolleyError volleyError) {
        //Log.i(TAG, "CosError: " + volleyError);
...
//        String url = Api.MIAN_URL + "?app=" + Api.APPID;
        StringRequest stringRequest = new StringRequest(Request.Method.POST, url  + "?app=" + Api.APPID,
                new com.android.volley.Response.Listener<String>() {
                    public void onResponse(String response) {
...
//            JSONObject jSONObject = new JSONObject(IO.a(Kodi.a(Rsa.decrypt_Rsa(response, Constant.a)),Constant.rq + Constant.dp));
            /*解析结果加密+偏移+rc4+gz解压*/
            JSONObject jSONObject = new JSONObject(new String(A(Base64.decode(IO.a(Kodi.a(Rsa.decrypt_Rsa(response, Constant.a)),Constant.rq + Constant.dp), Base64.DEFAULT)),"UTF-8"));
...
//                int searchport = config.optInt(Constant.searchport);/*远程搜索端口*/
                ...
                interface_style = config.optInt(Constant.hw);/*界面样式*/
                ...
                if (force_Style == 1){
                    ...
                    if (SharePreferenceDataUtil.getSharedStringData(SplashActivity.this, Constant.ud, null) != null){
                        interface_style = Integer.parseInt(SharePreferenceDataUtil.getSharedStringData(SplashActivity.this, "User_Style", null));/*界面样式*/
                    }
                }
